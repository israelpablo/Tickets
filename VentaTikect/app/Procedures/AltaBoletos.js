...
async function Alta (tabla,id,iduser,worsatation,active,username,pass,description,fname,lname,role,name,desgasma,castinma,wair,wwater,result,judgement,note,idfo,machine,tiempo) {
    try{
